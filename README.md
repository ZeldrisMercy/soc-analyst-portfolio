...
## 📂 Projetos e Laboratórios SOC

### 📑 Documentação e Governança (GRC/SOC)
* **[NovaBrew Security Audit - Análise de Risco Completa](projects/soc-documentation/security-audits/novabrew-security-audit/NovaBrew-Audit.md)**
    * Relatório executivo detalhado com matriz de risco, escopo e plano de remediação focado em e-commerce.
